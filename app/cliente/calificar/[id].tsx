...
export default function CalificarTecnicoScreen() {
    ...
    const cargarDatos = async () => {
        try {
            ...
            if (solicitudData.tecnico_id) {
                const { data: tecnicoData } = await supabase
                    .from('profiles')
                    .select('id, nombre, apellido')
                    .eq('id', solicitudData.tecnico_id)
                    .single();
                setTecnico(tecnicoData as Tecnico);
            }
        ...
        try {
            ...
            const { error } = await supabase
                ...
                .insert({
                    ...
                    calificado_id: solicitud?.tecnico_id,
    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.titulo}>Calificar Técnico</Text>
            </View>
            ...
            {tecnico && (
                <View style={styles.card}>
                    <Text style={styles.cardTitulo}>👤 Técnico</Text>
                    <Text style={styles.tecnicoNombre}>{tecnico.nombre} {tecnico.apellido}</Text>
                </View>
            )}

            <View style={styles.card}>
                <Text style={styles.cardTitulo}>⭐ Calificar al técnico</Text>
                {yaCalifico ? (
...
const styles = StyleSheet.create({
    ...
    tecnicoNombre: { fontSize: 16, fontWeight: 'bold', color: '#111827', marginBottom: 5 },
