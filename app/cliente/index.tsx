    ...
    return (
        ...
        >
            <View style={styles.header}>
                ...
                <Text style={styles.subtitulo}>Bienvenido Cliente</Text>
            </View>

            <View style={styles.menuContainer}>
                <Pressable style={styles.botonSolicitar} onPress={() => router.push('/cliente/solicitar')}>
                    <Text style={styles.botonEmoji}>➕</Text>
                    <Text style={styles.botonTitulo}>Solicitar</Text>
                    <Text style={styles.botonDescripcion}>Publicar una nueva reparación</Text>
                </Pressable>

                <Pressable style={styles.botonMisSolicitudes} onPress={() => router.push('/cliente/mis-solicitudes')}>
                    <Text style={styles.botonEmoji}>📋</Text>
                    <Text style={styles.botonTitulo}>Mis Solicitudes</Text>
                    <Text style={styles.botonDescripcion}>Ver el estado de tus reparaciones</Text>
                </Pressable>

                <Pressable style={styles.botonPerfil} onPress={() => router.push('/cliente/perfil')}>
                    <Text style={styles.botonEmoji}>👤</Text>
...
const styles = StyleSheet.create({
    ...
    botonSolicitar: { backgroundColor: '#111827', borderRadius: 20, padding: 25, alignItems: 'center', elevation: 5 },
    botonMisSolicitudes: { backgroundColor: 'white', borderRadius: 20, padding: 25, alignItems: 'center', elevation: 5, borderWidth: 1, borderColor: '#e5e7eb' },
